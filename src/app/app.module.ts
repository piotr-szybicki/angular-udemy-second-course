...
@NgModule({
  ...
  declarations: [ AppComponent, LandingPageComponent, FloatsLayoutComponent, AboutSectionComponent, ServicesComponent, DiscoverToursComponent, RecomendationsComponent ],
